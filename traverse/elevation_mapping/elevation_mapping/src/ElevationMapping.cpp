...
bool ElevationMapping::readParameters()
{
  ...
  nodeHandle_.param("point_cloud_topic", pointCloudTopic_, string("/velodyne_points"));  // /camera/depth/color/points
  nodeHandle_.param("robot_pose_with_covariance_topic", robotPoseTopic_, string("/base_link"));  // /pose
  nodeHandle_.param("track_point_frame_id", trackPointFrameId_, string("/base_link")); // /robot
  ...
  string frameId;
  nodeHandle_.param("map_frame_id", frameId, string("/map")); // /map
