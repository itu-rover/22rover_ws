...
from spiral_test import Approach_by_loc
from one_marker_test import  TurningAround
import smach
import smach_ros
...
def main_sub():
   ...
   sm_sub.userdata.post_number = 1 # if it is 4 do gate, otherwsie do one marker
   with sm_sub:
