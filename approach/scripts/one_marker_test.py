...
from geometry_msgs.msg import Quaternion, Point, Transform,PoseStamped
...
class TurningAround:
    ...
    def marker(self,data):
        for i in data.transforms:
            ...
            if i.fiducial_id not in self.count_marker.keys():
                ...
                self.send_goal(0,0,m.atan2(self.correct_transform.translation.y,self.correct_transform.translation.x),"base_link")
    ...
    def turn(self):
        ...
        self.send_goal(final_x, final_y, angle)
