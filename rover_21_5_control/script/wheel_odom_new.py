...
class Localization(object):
    ...
    def right_callback(self, data):
        self.front_right = data.data[0]
        self.back_right = data.data[1]
    
    def left_callback(self, data):
        self.front_left = data.data[0]
        self.back_left = data.data[1]
    ...
    def controller(self):
        ...
        while not rospy.is_shutdown():
            ...
            print(self.vx)
            # Position change
            self.delta_x = self.vx * cos(self.curr_yaw - self.init_yaw) * self.dt * 0.30 * math.pi / 60
            self.delta_y = self.vx * sin(self.curr_yaw - self.init_yaw) * self.dt * 0.30 * math.pi / 60
